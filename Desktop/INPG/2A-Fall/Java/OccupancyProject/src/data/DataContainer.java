...
/**
 * 
 *  Class to manage the read of a "csv" file and stock the data in the form of lists.
 */
public class DataContainer{
    ...
    /**
     *  Class allowing to read a "csv" file and stock the data in the form of lists.
     * 
    ...
    /**
     *  Method to add the sensor values to the data in the form of key -> values list
     * @param variableName: the sensor name
